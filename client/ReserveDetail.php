...
?>
    ...
    <div style="margin: 40px 130px 80px 130px">
        <div class="mainaccount"
             style="background: linear-gradient(180deg, lightblue 5%, floralwhite 55%, ghostwhite 40%);padding-bottom: 10px">
        ...
        <div style="margin:60px 0; text-align: center">
            <div style="margin: 0 10px 20px 10px">
                <a class="btn-primary" style="margin: 0 7px 0 7px"
                   href="http://localhost:8001/client/form/Asking.php?client_id=<?= $client_id; ?>&lesson_id=<?= $_GET['lesson_id'] ?>">
                    Reserve the course
                </a>
                <?php
